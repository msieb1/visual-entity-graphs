...
class CostFKBlock(Cost):
    ...
    def eval(self, sample):
        ...
        pt_ee_l = pt[:, 0:3] # endeffector position left
        pt_ee_r = pt[:, 3:6] # endeffector position right
        pt_ee_avg = 0.5 * (pt_ee_r + pt_ee_l) # endeffector position mean
        pt_block = pt[:, 6:9]  # block position
