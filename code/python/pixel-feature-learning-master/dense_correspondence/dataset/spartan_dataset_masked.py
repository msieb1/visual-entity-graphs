...
class SpartanDataset(DenseCorrespondenceDataset):
    ...
    def get_within_scene_data(self, scene_name, metadata, for_synthetic_multi_object=False):
        ...
        if self._domain_randomize:
            image_a_rgb = correspondence_augmentation.random_domain_randomize_background(image_a_rgb, image_a_mask, self._domain_randomize_use_img, self._background_rand_img_src)
            image_b_rgb = correspondence_augmentation.random_domain_randomize_background(image_b_rgb, image_b_mask, self._domain_randomize_use_img, self._background_rand_img_src)
