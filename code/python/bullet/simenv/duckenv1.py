...
class UserEnv(Env):
    ...
    def load(self):
        ...
        h.duckid = p.loadURDF(sysdatapath("duck_vhacd.urdf"), 1.050000,0.300000,0.700000,0.707107,0,0,0.707107)
    ...
    def reset(self):
        ...
        # p.resetBasePositionAndOrientation(self.h.cubeid, [1.050000,-0.500000,0.700000], [0.707107,0,0,0.707107])
        p.resetBasePositionAndOrientation(self.h.duckid, [1.050000,0.300000,0.700000], [0.707107,0,0,0.707107])
