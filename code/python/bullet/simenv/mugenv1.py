...
class UserEnv(Env):
    ...
    def load(self):
        ...
        h.ballid = p.loadURDF(userdatapath('sphere_small.urdf'), 0.850000,-0.400000,0.700000,0.000000,0.000000,0.707107,0.707107)
        # for tiny balls
        # h.ballid = p.loadURDF(userdatapath("sphere_1cm.urdf"), 0.850000,-0.400000,0.700000,0.000000,0.000000,0.707107,0.707107)
    ...
    def objects(self):
        return (self.h.kuka, self.h.mugid, self.h.ballid)

    def reset(self):
        self.o.kukaobject.kuka_reset()
        p.resetBasePositionAndOrientation(self.h.ballid, [0.850000,-0.400000,0.700000], [0.000000,0.000000,0.707107,0.707107])
