# objects: very heavy blue cube (middle)
...
class UserEnv(Env):
    ...
    def load(self):
        ...
        h.cubeid = p.loadURDF(userdatapath('cube_blue.urdf'), 0.850000,-0.400000,0.700000,0.000000,0.000000,0.707107,0.707107)
    ...
    def objects(self):
        return (self.h.kuka, self.h.cubeid)
