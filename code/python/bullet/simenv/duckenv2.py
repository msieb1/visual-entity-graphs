# objects: mug (right), duck(right), cube (middle)
...
class UserEnv(Env):
    ...
    def load(self):
        ...
        # h.bowlid = p.loadURDF(userdatapath('bowl.urdf'), 1.050000,-0.500000,0.700000,0.707107,0,0,0.707107)
        h.mugid = p.loadURDF(userdatapath('cup.urdf'), 1.050000,0.300000,0.700000,0.707107,0,0,0.707107)
        h.cubeid = p.loadURDF(sysdatapath("cube_small.urdf"), 0.950000,-0.100000,0.700000,0.000000,0.000000,0.707107,0.707107)
        # h.sphereid = [p.loadURDF(sysdatapath("sphere_small.urdf"), 0.850000,-0.400000,0.700000,0.000000,0.000000,0.707107,0.707107)]
    ...
    def objects(self):
        return (self.h.kuka, self.h.mugid, self.h.cubeid, self.h.duckid)
    ...
    def reset(self):
        ...
        # p.resetBasePositionAndOrientation(self.h.sphereid, [0.850000,-0.400000,0.700000], [0.000000,0.000000,0.707107,0.707107])
        p.resetBasePositionAndOrientation(self.h.duckid, [0.850000,-0.400000,0.900000], [0.000000,0.000000,0.707107,0.707107])
        p.resetBasePositionAndOrientation(self.h.mugid, [1.050000,0.300000,0.700000], [0.707107,0,0,0.707107])
