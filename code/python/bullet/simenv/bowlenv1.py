...
class UserEnv(Env):
    ...
    def load(self):
        ...
        # h.duckid = p.loadURDF(sysdatapath("duck_vhacd.urdf"), 0.850000,-0.180000,0.700000,0.000000,0.000000,0.707107,0.707107)

        #objects = [p.loadURDF(sysdatapath("sphere_small.urdf"), 0.850000,-0.400000,0.700000,0.000000,0.000000,0.707107,0.707107)]
        # h.duck2id = p.loadURDF(sysdatapath("duck_vhacd.urdf"), 0.850000,-0.400000,0.900000,0.000000,0.000000,0.707107,0.707107)
        self.h = h
        self.o = o
