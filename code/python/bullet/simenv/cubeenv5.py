# objects: red cube (middle), green cube (left)
...
class UserEnv(Env):
    ...
    def load(self):
        ...
        h.cubeid = p.loadURDF(userdatapath('cube_red.urdf'), 0.850000,-0.400000,0.700000,0.000000,0.000000,0.707107,0.707107)
        h.cubeid2 = p.loadURDF(userdatapath('cube_green.urdf'), 0.950000,-0.200000,0.700000,0.000000,0.000000,0.707107,0.707107)
    ...
    def objects(self):
        return (self.h.kuka, self.h.cubeid, self.h.cubeid2)

    def reset(self):
        self.o.kukaobject.kuka_reset()
        # p.resetBasePositionAndOrientation(self.h.prismatic, [0.950000,-0.100000,0.700000], [0.000000,0.000000,0.707107,0.707107])
        p.resetBasePositionAndOrientation(self.h.cubeid, [0.850000,-0.400000,0.700000],[0.000000,0.000000,0.707107,0.707107])
        p.resetBasePositionAndOrientation(self.h.cubeid2, [0.950000,-0.200000,0.700000],[0.000000,0.000000,0.707107,0.707107])
