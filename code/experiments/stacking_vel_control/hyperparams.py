...
MRCNN_MODEL_DIR = '/media/zhouxian/ed854110-6801-4dcd-9acf-c4f904955d71/iccv2019/synthetic_data_generation/iccv2019/mask_rcnn_models'
MRCNN_WEIGHTS_FILE = join(MRCNN_MODEL_DIR, 'baxter20190316T1348/mask_rcnn_baxter_0142.h5')
### Demo Parameters ###
DEMO_NAME = 'orangesquare_on_purplering_view0'
TASK_NAME = 'stack'
...
hand_traj = preprocess_hand_trajectory(hand_traj_path, join(DEMO_PATH, 'depth', '{}.npy'.format(DEMO_NAME)))
...
if agent['recompute_demo_values'] or not os.path.exists(join(DEMO_PATH, 'videos/poses', DEMO_NAME, 'right_hand_f_mean_trajectory.npy')):
    ...
    f_mean_traj, dep_f_mean_traj, gripper_binary_traj = get_unprojected_3d_mean_finger_and_gripper_trajectory(
                                                    l_f_traj, r_f_traj, agent['gripper_threshold'], intrin=INTRIN)#, img_height=IMAGE_HEIGHT, img_width=IMAGE_WIDTH)
...
cost_wt[:3] *= 0.1 # decrease hand weight
cost_wt[[2, 5]] *= 2.0 # depth was halfed during deprojection
# cost_wt[-1] = 0
state_cost_geom = {
    'type': CostState,
    'l1': 1.0,
